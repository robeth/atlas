...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleTenantCodeAlreadyExistsException(TenantCodeAlreadyExistsException ex) {
        log.error("Tenant code already exists: {}", ex.getMessage());
